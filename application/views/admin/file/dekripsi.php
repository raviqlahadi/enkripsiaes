<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="page-title-box">
        ...
        <h4 class="page-title m-0">Dekripsi File</h4>
      </div>
  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="card">
        <div class="card-body">
          <h4 class="m-t-0 header-title"><b>Pilih Jenis Dekripsi dan Masukan Key</b></h4>
          ...
          <div class="row">
            ...
            <?php if($status):?>
                  ...
                  <?php endif;?>
              <div class="demo-box">
                <?php echo form_open(site_url('admin/file/decrypt/'.urlencode($file_info->name)));?>
